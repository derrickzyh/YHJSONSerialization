...
//  JSONDemo
//
//  Created by xuancong on 14-8-13.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    id object=[sampleAllString objectFromJSON];
    ...
    jsonStr=[sampleJSONArray JSONStringFromArray];
    NSLog(@"%@", jsonStr);
